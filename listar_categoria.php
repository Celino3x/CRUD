              ...
              while ($array = mysqli_fetch_array($busca)) {
               ...
               ?>
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-warning btn-sm btedit" href="editarcategoria.php?id=<?php echo $id_categoria ?>" role="button"><i class="far fa-edit"></i>Editar</a>
                    <a class="btn btn-danger btn-sm btedit" href="deletecategoria.php?id=<?php echo $id_categoria ?>" role="button"><i class="far fa-trash-alt"></i>Excluir</a>
                  </td>
                </tr>
